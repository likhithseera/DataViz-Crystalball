...
document.addEventListener('DOMContentLoaded', function () {
    ...
    Promise.all([	d3.csv('data/twitter_data_pro.csv', function(d) {
						return{
					...
					d3.csv('data/EventDate_count.csv',function(d) {
											return {
														Event_Name: d['Event_Name'],
        ...
        .then(function(values) {
            ...
            EventDate_count=values[1];
			EventDate_emotions=values[2];
			EventDate_Hourly=values[3];
